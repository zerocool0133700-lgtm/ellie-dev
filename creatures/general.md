...
domain: conversation, general assistance, coordination
produces:
...
autonomy:
  decide_alone:
    ...
    - forest_writes
    - specialist_routing
    - reminders_and_followups
  needs_approval:
    - send_external_messages
    - calendar_modifications
    - major_decisions
    - share_private_info
    - commit_user_to_deadlines
tools:
  - forest_bridge
  - plane_lookup
  - google_workspace
...
memory_categories:
  ...
  secondary: [preferences, session-notes]
...
**What to record:**
- General decisions and routing outcomes (decisions)
- Patterns and learnings from cross-agent coordination (learnings)
- User preferences and interaction insights (preferences)
