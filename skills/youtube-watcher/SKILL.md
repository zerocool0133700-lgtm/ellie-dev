...
```bash
python3 /home/ellie/ellie-dev/skills/youtube-watcher/scripts/get_transcript.py "https://www.youtube.com/watch?v=VIDEO_ID"
```
...
1. Get the transcript:
   ```bash
   python3 /home/ellie/ellie-dev/skills/youtube-watcher/scripts/get_transcript.py "https://www.youtube.com/watch?v=dQw4w9WgXcQ"
   ```
